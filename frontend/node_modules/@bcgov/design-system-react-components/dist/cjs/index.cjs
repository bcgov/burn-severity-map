...
function $f39a9eba43920ace$export$8dc98ba7eadeaa56(props) {
    ...
    }, children) : /*#__PURE__*/ ($4AOtR$reactdom.createPortal)(children, $f39a9eba43920ace$var$hiddenFragment);
}
...
function $e1995378a142960e$var$useCollectionDocument(createCollection) {
    ...
    let [document] = ($dbSRa$react.useState)(()=>new ($681cc3c98f569e39$export$b34a105447964f9f)((createCollection === null || createCollection === undefined ? undefined : createCollection()) || new ($23b9f4fcf0fe224b$export$408d25a4e12db025)()));
...
function $e1995378a142960e$var$CollectionRoot({ children: children }) {
    ...
    return ($b5e257d569688ac6$export$535bd6ca7f90a273)() ? /*#__PURE__*/ ($dbSRa$react).createElement($e1995378a142960e$var$SSRContext.Provider, {
        value: doc
    }, wrappedChildren) : /*#__PURE__*/ ($4AOtR$reactdom.createPortal)(wrappedChildren, doc);
}
...
function $2a41e45df1593e64$export$d39e1813b3bdd0e1(props) {
    ...
    let lastScale = ($dbSRa$react.useRef)($2a41e45df1593e64$var$visualViewport === null || $2a41e45df1593e64$var$visualViewport === undefined ? undefined : $2a41e45df1593e64$var$visualViewport.scale);
    ($dbSRa$react.useEffect)(()=>{
...
function $96b38030c423d352$export$574e9b0fb070c3b0() {
    var _useContext;
    return (_useContext = ($dbSRa$react.useContext)($96b38030c423d352$export$60d741e20e0aa309)) !== null && _useContext !== undefined ? _useContext : {};
}
...
function $ae20dd8cbca75726$export$d6daf82dcd84e87c(options) {
    ...
    let shouldVirtualFocusFirst = ($dbSRa$react.useRef)(false);
...
function $5e910fae8e128ead$export$6e3e27031a30522f(props, state, ref) {
    ...
    let raf = ($dbSRa$react.useRef)(null);
    let handleBeforeMatch = ($dbSRa$react.useCallback)(()=>{
...
function $58aed456727eb0f3$export$e64b2f635402ca43(props, state, ref) {
    ...
    let delegate = ($dbSRa$react.useMemo)(()=>keyboardDelegate || new ($2a25aae57d74318e$export$a05409b8bb224a5a)(state.collection, state.disabledKeys, ref, collator), [
        keyboardDelegate,
        state.collection,
        state.disabledKeys,
        collator
...
const $d2b4bc8c273e7be6$export$353f5b6fc5456de1 = /*#__PURE__*/ ($f39a9eba43920ace$export$86427a43e3e48ebb)(function Button(props, ref) {
    ...
    let wasPending = ($dbSRa$react.useRef)(isPending);
    ($dbSRa$react.useEffect)(()=>{
        let message = {
...
const $514c0188e459b4c0$export$5f1af8db9871e1d6 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function Text(props, ref) {
...
const $ee014567cb39d3f0$export$f551688fc98f2e09 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function FieldError(props, ref) {
...
function $bf996d45f4a36925$export$3fcbf6e4407997e0(props) {
    ...
    const expand = ($dbSRa$react.useCallback)(()=>{
        setExpanded(true);
    }, [
        setExpanded
    ]);
    const collapse = ($dbSRa$react.useCallback)(()=>{
        setExpanded(false);
    }, [
        setExpanded
    ]);
...
function $9385b3affbdec831$export$f36461af0ef4707d(props) {
    ...
    let [expandedKeys, setExpandedKeys] = ($458b0a5536c1a7cf$export$40bfa8c7b0832715)(($dbSRa$react.useMemo)(()=>props.expandedKeys ? new Set(props.expandedKeys) : undefined, [
        props.expandedKeys
    ]), ($dbSRa$react.useMemo)(()=>props.defaultExpandedKeys ? new Set(props.defaultExpandedKeys) : new Set(), [
...
function $8796f90736e175cb$export$4d40659c25ecb50b(props = {}) {
    ...
    let closeTimeout = ($dbSRa$react.useRef)(null);
...
const $d3e0e05bdfcf66bd$export$a7fed597f4b8afd8 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function Form(props, ref) {
...
const $216918bed6669f72$export$f5c9f3c2c4054eec = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function TextArea(props, ref) {
...
const $bcdf0525bf22703d$export$2c73285ae9390cec = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function TextField(props, ref) {
...
const $d2f53cda644affe3$export$65d2a03b8800d6e3 = /*#__PURE__*/ ($dbSRa$react.createContext)(null);
...
const $4f118338184dc1d9$export$a6c7ac8248d6e38a = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function Link(props, ref) {
...
const $bc237834342dbd75$export$4aa08d5625cb8ead = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function CheckboxGroup(props, ref) {
...
const $bc237834342dbd75$export$48513f6b9f8ce62d = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function Checkbox(props, ref) {
...
const $612b8eb6cb90e02d$export$62ed72bc21f6b8a6 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function DropIndicator(props, ref) {
...
const $eed445e0843c11d0$export$41f133550aa26f48 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function ListBox(props, ref) {
...
function $eed445e0843c11d0$var$StandaloneListBox({ props: props, listBoxRef: listBoxRef, collection: collection }) {
    ...
    let { layoutDelegate: layoutDelegate } = ($dbSRa$react.useContext)(($7135fc7d473fd974$export$4feb769f8ddf26c5));
    let { filterFn: filterFn, collectionProps: collectionProps, collectionRef: collectionRef } = ($dbSRa$react.useContext)(($d2f53cda644affe3$export$65d2a03b8800d6e3)) || {};
    // Memoed so that useAutocomplete callback ref is properly only called once on mount and not everytime a rerender happens
    listBoxRef = ($df56164dff5785e2$export$4338b53315abf666)(($dbSRa$react.useMemo)(()=>($5dc95899b306f630$export$c9058316764c140e)(listBoxRef, collectionRef !== undefined ? collectionRef : null), [
        collectionRef,
        listBoxRef
    ]));
    let filteredCollection = ($dbSRa$react.useMemo)(()=>filterFn ? collection.filter(filterFn) : collection, [
        collection,
        filterFn
    ]);
...
const $44f671af83e7d9e0$export$746d02f47f4d381 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function OverlayArrow(props, ref) {
...
const $28f4fd908f0de97f$export$1d40e3e0cc4d5de = /*#__PURE__*/ ($dbSRa$react.createContext)(null);
const $28f4fd908f0de97f$export$944aceb4f8c89f10 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function DisclosureGroup(props, ref) {
...
const $28f4fd908f0de97f$export$d665dd135a51b28a = /*#__PURE__*/ ($dbSRa$react.createContext)(null);
const $28f4fd908f0de97f$export$dab3ea4a6ef094da = /*#__PURE__*/ ($dbSRa$react.createContext)(null);
const $28f4fd908f0de97f$var$InternalDisclosureContext = /*#__PURE__*/ ($dbSRa$react.createContext)(null);
const $28f4fd908f0de97f$export$74a362b31437ec83 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function Disclosure(props, ref) {
    [props, ref] = ($64fa3d84918910a7$export$29f1550f4b0d4415)(props, ref, $28f4fd908f0de97f$export$d665dd135a51b28a);
    let groupState = ($dbSRa$react.useContext)($28f4fd908f0de97f$export$1d40e3e0cc4d5de);
...
const $28f4fd908f0de97f$export$feabaa331e1d464c = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function DisclosurePanel(props, ref) {
    let { role: role = 'group' } = props;
    let { panelProps: panelProps, panelRef: panelRef } = ($dbSRa$react.useContext)($28f4fd908f0de97f$var$InternalDisclosureContext);
    let { isFocusVisible: isFocusVisibleWithin, focusProps: focusWithinProps } = ($f7dceffc5ad7768b$export$4e328f61c538687f)({
        within: true
    });
    let renderProps = ($64fa3d84918910a7$export$4d86445c2cf5e3)({
...
const $b6c3ddc6086f204d$export$a98f0dcb43a68a25 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function RadioGroup(props, ref) {
...
const $b6c3ddc6086f204d$export$d7b12c4107be0d61 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function Radio(props, ref) {
    let { inputRef: userProvidedInputRef = null, ...otherProps } = props;
...
const $82d7e5349645de74$export$ef9b1a59e592288f = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function Select(props, ref) {
...
const $82d7e5349645de74$export$e288731fd71264f0 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function SelectValue(props, ref) {
...
const $8e59e948500a8fe1$export$b5d5cf8927ab7262 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function Switch(props, ref) {
    let { inputRef: userProvidedInputRef = null, ...otherProps } = props;
...
const $eaf9e70818b436db$export$67ea30858aaf75e3 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function TagGroup(props, ref) {
...
const $eaf9e70818b436db$export$f9fef0f55402315b = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function TagList(props, ref) {
    let state = ($dbSRa$react.useContext)(($eed445e0843c11d0$export$7c5906fe4f1f2af2));
...
const $4e3b923658d69c60$export$28c660c63b792dea = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function Tooltip({ UNSTABLE_portalContainer: UNSTABLE_portalContainer, ...props }, ref) {
...
function Button({ size = "medium", variant = "primary", danger = false, isIconButton = false, ...props }) {
    return (jsxRuntime.jsx($d2b4bc8c273e7be6$export$353f5b6fc5456de1, { className: `bcds-react-aria-Button ${size} ${variant} ${danger ? "danger" : ""} ${isIconButton ? "icon" : ""}`, ...props }));
}
...
function SvgChevronDownIcon({ id = "chevron-down-icon" }) {
    return (jsxRuntime.jsx("svg", { id: id, width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("path", { d: "M15.7882 9.15569L10.4858 14.236C10.3192 14.3748 10.1527 14.4303 10.0139 14.4303C9.84731 14.4303 9.68074 14.3748 9.54194 14.2637L4.21182 9.15569C3.9342 8.90584 3.9342 8.46167 4.18405 8.21182C4.4339 7.9342 4.87808 7.9342 5.12793 8.18405L10.0139 12.8479L14.872 8.18405C15.1219 7.9342 15.5661 7.9342 15.8159 8.21182C16.0658 8.46167 16.0658 8.90584 15.7882 9.15569Z", fill: "currentColor" }) }));
}

function Accordion({ label, children, ...props }) {
    return (jsxRuntime.jsx($28f4fd908f0de97f$export$74a362b31437ec83, { className: `bcds-react-aria-Disclosure`, ...props, children: ({ isExpanded }) => (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs(Button, { className: "bcds-react-aria-Disclosure--Button", size: "small", variant: "link", slot: "trigger", children: [label, isExpanded ? jsxRuntime.jsx(SvgChevronUpIcon, {}) : jsxRuntime.jsx(SvgChevronDownIcon, {})] }), jsxRuntime.jsx($28f4fd908f0de97f$export$feabaa331e1d464c, { className: "bcds-react-aria-Disclosure--Panel", children: jsxRuntime.jsx(jsxRuntime.Fragment, { children: children }) })] })) }));
}
...
function AccordionGroup({ title, titleElement, children, ...props }) {
    function getTitle() {
        switch (titleElement) {
            case "h1":
                return jsxRuntime.jsx("h1", { children: title });
            case "h2":
                return jsxRuntime.jsx("h2", { children: title });
            case "h3":
                return jsxRuntime.jsx("h3", { children: title });
            case "h4":
                return jsxRuntime.jsx("h4", { children: title });
            case "h5":
                return jsxRuntime.jsx("h5", { children: title });
            case "h6":
                return jsxRuntime.jsx("h6", { children: title });
            default:
                return jsxRuntime.jsx("span", { children: title });
        }
    }
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [title && (jsxRuntime.jsx("div", { className: "bcds-react-aria-DisclosureGroup--Title", children: getTitle() })), jsxRuntime.jsx($28f4fd908f0de97f$export$944aceb4f8c89f10, { className: "bcds-react-aria-DisclosureGroup", ...props, children: children })] }));
}
...
function SvgCheckCircleIcon({ id = "check-icon" }) {
    return (jsxRuntime.jsx("svg", { id: id, width: "20", height: "20", viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("g", { children: jsxRuntime.jsx("path", { d: "M12.4688 7.46875C12.75 7.1875 13.2188 7.1875 13.5 7.5C13.8125 7.78125 13.8125 8.25 13.5 8.53125L9.5 12.5312C9.375 12.6875 9.1875 12.75 9 12.75C8.78125 12.75 8.59375 12.6875 8.4375 12.5312L6.4375 10.5312C6.125 10.25 6.125 9.78125 6.4375 9.46875C6.71875 9.1875 7.1875 9.1875 7.5 9.46875L9 10.9688L12.4688 7.46875ZM10 2C14.4062 2 18 5.59375 18 10C18 14.4375 14.4062 18 10 18C5.5625 18 2 14.4375 2 10C2 5.59375 5.5625 2 10 2ZM10 16.5C13.5625 16.5 16.5 13.5938 16.5 10C16.5 6.4375 13.5625 3.5 10 3.5C6.40625 3.5 3.5 6.4375 3.5 10C3.5 13.5938 6.40625 16.5 10 16.5Z", fill: "currentColor" }) }) }));
}
...
function SvgCloseIcon({ id = "close-icon" }) {
    return (jsxRuntime.jsx("svg", { id: id, width: "20", height: "20", viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("g", { children: jsxRuntime.jsx("path", { d: "M16 5.21286L14.7871 4L10 8.78714L5.21286 4L4 5.21286L8.78714 10L4 14.7871L5.21286 16L10 11.2129L14.7871 16L16 14.7871L11.2129 10L16 5.21286Z", fill: "currentColor" }) }) }));
}
...
function SvgExclamationCircleIcon({ id = "exclamation-icon-circle", }) {
    return (jsxRuntime.jsx("svg", { id: id, width: "20", height: "20", viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("g", { children: jsxRuntime.jsx("path", { d: "M9.99999 2C14.4062 2 18 5.59375 18 10C18 14.4375 14.4062 18 9.99999 18C5.56249 18 1.99998 14.4375 1.99998 10C1.99998 5.59375 5.56249 2 9.99999 2ZM9.99999 16.5C13.5625 16.5 16.5 13.5938 16.5 10C16.5 6.4375 13.5625 3.5 9.99999 3.5C6.40624 3.5 3.49999 6.4375 3.49999 10C3.49999 13.5938 6.40624 16.5 9.99999 16.5ZM9.99999 11.5C9.56249 11.5 9.24999 11.1875 9.24999 10.75V6.75C9.24999 6.34375 9.56249 6 9.99999 6C10.4062 6 10.75 6.34375 10.75 6.75V10.75C10.75 11.1875 10.4062 11.5 9.99999 11.5ZM9.99999 12.5625C10.5312 12.5625 10.9687 13 10.9687 13.5312C10.9687 14.0625 10.5312 14.5 9.99999 14.5C9.43749 14.5 8.99999 14.0625 8.99999 13.5312C8.99999 13 9.43749 12.5625 9.99999 12.5625Z", fill: "currentColor" }) }) }));
}
...
function SvgInfoIcon({ id = "information-icon" }) {
    return (jsxRuntime.jsx("svg", { id: id, width: "20", height: "20", viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("g", { children: jsxRuntime.jsx("path", { d: "M9.99999 2C14.4062 2 18 5.59375 18 10C18 14.4375 14.4062 18 9.99999 18C5.56249 18 1.99998 14.4375 1.99998 10C1.99998 5.59375 5.56249 2 9.99999 2ZM9.99999 16.5C13.5625 16.5 16.5 13.5938 16.5 10C16.5 6.4375 13.5625 3.5 9.99999 3.5C6.40624 3.5 3.49999 6.4375 3.49999 10C3.49999 13.5938 6.40624 16.5 9.99999 16.5ZM11.25 12.5C11.6562 12.5 12 12.8438 12 13.25C12 13.6875 11.6562 14 11.25 14H8.74999C8.31249 14 7.99999 13.6875 7.99999 13.25C7.99999 12.8438 8.31249 12.5 8.74999 12.5H9.24999V10.5H8.99999C8.56249 10.5 8.24999 10.1875 8.24999 9.75C8.24999 9.34375 8.56249 9 8.99999 9H9.99999C10.4062 9 10.75 9.34375 10.75 9.75V12.5H11.25ZM9.99999 8C9.43749 8 8.99999 7.5625 8.99999 7C8.99999 6.46875 9.43749 6 9.99999 6C10.5312 6 11 6.46875 11 7C11 7.5625 10.5312 8 9.99999 8Z", fill: "currentColor" }) }) }));
}
...
function getIcon$2(variant) {
    switch (variant) {
        case "info":
            return jsxRuntime.jsx(SvgInfoIcon, {});
        case "black":
            return jsxRuntime.jsx(SvgInfoIcon, {});
        case "success":
            return jsxRuntime.jsx(SvgCheckCircleIcon, {});
        case "warning":
            return jsxRuntime.jsx(SvgExclamationIcon, {});
        case "danger":
            return jsxRuntime.jsx(SvgExclamationCircleIcon, {});
        default:
            return;
    }
}
function AlertBanner({ variant = "info", isIconHidden = false, isCloseable = true, role = "status", onClose, children, customIcon, ...props }) {
    return (jsxRuntime.jsx("div", { className: `bcds-Alert-Banner ${variant}`, ...props, children: jsxRuntime.jsxs("div", { className: "bcds-Alert-Banner--Container", children: [" ", !isIconHidden && (jsxRuntime.jsx("span", { className: "bcds-Alert-Banner--Icon", children: customIcon ? customIcon : getIcon$2(variant) })), jsxRuntime.jsx("div", { className: "bcds-Alert-Banner--Content", role: role, children: children }), isCloseable && (jsxRuntime.jsx("span", { className: "bcds-Alert-Banner--closeIcon", children: jsxRuntime.jsx(Button, { variant: "tertiary", isIconButton: true, size: "small", "aria-label": "Close this alert", type: "button", onPress: onClose, children: jsxRuntime.jsx(SvgCloseIcon, {}) }) }))] }) }));
}
...
function ButtonGroup({ orientation = "horizontal", alignment = "start", ariaLabel, children, ...props }) {
    return (jsxRuntime.jsx("div", { className: `bcds-ButtonGroup ${orientation} ${alignment}`, role: "group", "aria-label": ariaLabel, ...props, children: children }));
}
...
function AlertDialog({ children, variant = "info", role = "dialog", title, isCloseable = true, isIconHidden = false, buttons, ...props }) {
    return (jsxRuntime.jsx($de32f1b87079253c$export$3ddf2d174ce01153, { className: `bcds-react-aria-AlertDialog ${variant}`, role: role, ...props, children: ({ close }) => (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("div", { className: "bcds-react-aria-AlertDialog--Header", children: [!isIconHidden && (jsxRuntime.jsx("div", { className: "bcds-react-aria-AlertDialog--Icon", children: getIcon$1(variant) })), title && (jsxRuntime.jsx("div", { className: "bcds-react-aria-AlertDialog--Title", slot: "title", children: title })), isCloseable && (jsxRuntime.jsx("div", { className: "bcds-react-aria-AlertDialog--closeIcon", children: jsxRuntime.jsx(Button, { variant: "tertiary", isIconButton: true, size: "small", "aria-label": "Close", type: "button", onPress: close, children: jsxRuntime.jsx(SvgCloseIcon, {}) }) }))] }), children && (jsxRuntime.jsx("div", { className: "bcds-react-aria-AlertDialog--children", slot: "children", children: jsxRuntime.jsx(jsxRuntime.Fragment, { children: children }) })), buttons && (jsxRuntime.jsx(ButtonGroup, { alignment: "end", orientation: "horizontal", children: buttons }))] })) }));
}
...
function Callout({ variant = "lightGrey", title, description, buttons, role = "note", isLeftBorderDisabled = false, children, ...props }) {
    return (jsxRuntime.jsx("div", { className: `bcds-Callout ${variant} ${isLeftBorderDisabled ? "noBorder" : ""}`, ...props, role: role, children: children ? (children) : (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", { className: "bcds-Callout--Container", "aria-labelledby": "callout-title", role: role, children: [title && (jsxRuntime.jsx("span", { className: "bcds-Callout--Title", id: "callout-title", children: title })), description && (jsxRuntime.jsx("span", { className: "bcds-Callout--Description", children: description })), buttons && (jsxRuntime.jsx(ButtonGroup, { alignment: "start", orientation: "horizontal", children: buttons }))] }) })) }));
}
...
function Checkbox({ value, children, ...props }) {
    return (jsxRuntime.jsx($bc237834342dbd75$export$48513f6b9f8ce62d, { className: "bcds-react-aria-Checkbox", value: value, ...props, children: ({ isRequired, isSelected, isIndeterminate }) => (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("div", { className: "checkbox", children: [isSelected && !isIndeterminate && jsxRuntime.jsx(SvgCheckIcon, {}), isIndeterminate && jsxRuntime.jsx(SvgDashIcon, {})] }), jsxRuntime.jsxs("span", { className: "label", children: [jsxRuntime.jsx(jsxRuntime.Fragment, { children: children }), " ", isRequired && "(required)"] })] })) }));
}
...
function CheckboxGroup({ orientation = "vertical", label, description, errorMessage, flexWrap = "nowrap", children, ...props }) {
    return (jsxRuntime.jsx($bc237834342dbd75$export$4aa08d5625cb8ead, { className: `bcds-react-aria-CheckboxGroup`, ...props, children: ({ isRequired, isInvalid }) => (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [label && (jsxRuntime.jsxs($01b77f81d0f07f68$export$b04be29aa201d4f5, { className: "bcds-react-aria-CheckboxGroup--label", children: [label, " ", isRequired && "(required)"] })), jsxRuntime.jsx("div", { className: `bcds-react-aria-CheckboxGroup--options ${orientation} flex-wrap-${flexWrap}`, children: jsxRuntime.jsx(jsxRuntime.Fragment, { children: children }) }), description && (jsxRuntime.jsx($514c0188e459b4c0$export$5f1af8db9871e1d6, { slot: "description", className: "bcds-react-aria-CheckboxGroup--description", children: description })), isInvalid && (jsxRuntime.jsxs("div", { className: "bcds-react-aria-CheckboxGroup--error", children: [jsxRuntime.jsx(SvgExclamationIcon, {}), jsxRuntime.jsx($ee014567cb39d3f0$export$f551688fc98f2e09, { children: errorMessage })] }))] })) }));
}
...
function FooterLinks({ title, links }) {
    return (jsxRuntime.jsxs("figure", { className: "bcds-footer--links", children: [title && (jsxRuntime.jsx("figcaption", { className: "bcds-footer--links-title", children: title })), links && (jsxRuntime.jsx("ul", { children: Array.isArray(links) &&
                    links.map((link, index) => {
                        return (jsxRuntime.jsx("li", { children: link }, `${title.toLowerCase().replace(/\s/g, "-")}-${index}`));
                    }) }))] }));
}
/**
...
function Footer({ children, acknowledgement, logo, contact, links, copyright, hideAcknowledgement = false, hideLogoAndLinks = false, hideCopyright = false, }) {
    function defaultAcknowledgement() {
        return (jsxRuntime.jsx("p", { children: "The B.C. Public Service acknowledges the territories of First Nations around B.C. and is grateful to carry out our work on these lands. We acknowledge the rights, interests, priorities, and concerns of all Indigenous Peoples \u2014 First Nations, M\u00E9tis, and Inuit \u2014 respecting and acknowledging their distinct cultures, histories, rights, laws, and governments." }));
    }
    function defaultLogo() {
        return jsxRuntime.jsx(SvgBcLogo, { id: "bcgov-logo-footer" });
    }
    function defaultContact() {
        ...
        return (jsxRuntime.jsxs("p", { children: ["We can help in over 220 languages and through other accessible options.", " ", jsxRuntime.jsx("a", { href: "https://www2.gov.bc.ca/gov/content?id=6A77C17D0CCB48F897F8598CCC019111", children: "Call, email or text us" }), ", or", " ", jsxRuntime.jsx("a", { href: "https://www2.gov.bc.ca/gov/content?id=FBC4210F6BC047A5884198F543C97D53", children: "find a service centre" })] }));
    }
    function defaultLinks() {
        return (jsxRuntime.jsx(FooterLinks, { title: "More Info", links: [
                jsxRuntime.jsx("a", { href: "https://www2.gov.bc.ca/gov/content/home", children: "Home" }),
                jsxRuntime.jsx("a", { href: "https://www2.gov.bc.ca/gov/content?id=3C4F47288DFB454987435AB5EFEFBB7F", children: "About gov.bc.ca" }),
                jsxRuntime.jsx("a", { href: "https://www2.gov.bc.ca/gov/content?id=79F93E018712422FBC8E674A67A70535", children: "Disclaimer" }),
                jsxRuntime.jsx("a", { href: "https://www2.gov.bc.ca/gov/content?id=9E890E16955E4FF4BF3B0E07B4722932", children: "Privacy" }),
                jsxRuntime.jsx("a", { href: "https://www2.gov.bc.ca/gov/content?id=E08E79740F9C41B9B0C484685CC5E412", children: "Accessibility" }),
                jsxRuntime.jsx("a", { href: "https://www2.gov.bc.ca/gov/content?id=1AAACC9C65754E4D89A118B875E0FBDA", children: "Copyright" }),
                jsxRuntime.jsx("a", { href: "https://www2.gov.bc.ca/gov/content?id=6A77C17D0CCB48F897F8598CCC019111", children: "Contact us" }),
            ] }));
    }
    const defaultCopyright = `© ${new Date().getUTCFullYear()} Government of British Columbia.`;
    return (jsxRuntime.jsxs("footer", { className: "bcds-footer", children: [!hideAcknowledgement && (jsxRuntime.jsx("div", { className: "bcds-footer--acknowledgement", children: jsxRuntime.jsx("div", { className: "bcds-footer--acknowledgement-text", children: acknowledgement ? acknowledgement : defaultAcknowledgement() }) })), jsxRuntime.jsx("div", { className: "bcds-footer--container", children: jsxRuntime.jsxs("div", { className: "bcds-footer--container-content", children: [!hideLogoAndLinks && (jsxRuntime.jsx("div", { className: `bcds-footer--logo-links ${children ? "vertical" : "horizontal"}`, children: children ? (children) : (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("div", { className: "bcds-footer--logo", children: [logo ? logo : defaultLogo(), contact ? contact : defaultContact()] }), links ? links : defaultLinks()] })) })), !hideLogoAndLinks && !hideCopyright && jsxRuntime.jsx("hr", {}), !hideCopyright && (jsxRuntime.jsx("p", { className: "bcds-footer--copyright", children: copyright ? copyright : defaultCopyright }))] }) })] }));
}

function Form({ ...props }) {
    return jsxRuntime.jsx($d3e0e05bdfcf66bd$export$a7fed597f4b8afd8, { ...props });
}
...
function Header({ children, logoLinkElement, logoImage = jsxRuntime.jsx(SvgBcLogo, { id: "bcgov-logo-header" }), skipLinks, title = "", titleElement = "span", }) {
    function getLogo() {
        if (!logoLinkElement)
            return (jsxRuntime.jsx("a", { href: "/", title: "Government of British Columbia", children: logoImage }));
        return $dbSRa$react.cloneElement(logoLinkElement, { children: logoImage });
    }
    function getTitle() {
        switch (titleElement) {
            case "h1":
                return jsxRuntime.jsx("h1", { className: "bcds-header--title", children: title });
            case "h2":
                return jsxRuntime.jsx("h2", { className: "bcds-header--title", children: title });
            case "h3":
                return jsxRuntime.jsx("h3", { className: "bcds-header--title", children: title });
            case "h4":
                return jsxRuntime.jsx("h4", { className: "bcds-header--title", children: title });
            case "h5":
                return jsxRuntime.jsx("h5", { className: "bcds-header--title", children: title });
            case "h6":
                return jsxRuntime.jsx("h6", { className: "bcds-header--title", children: title });
            case "p":
                return jsxRuntime.jsx("p", { className: "bcds-header--title", children: title });
            default:
                return jsxRuntime.jsx("span", { className: "bcds-header--title", children: title });
        }
    }
    return (jsxRuntime.jsx("header", { className: "bcds-header", children: jsxRuntime.jsxs("div", { className: "bcds-header--container", children: [getLogo(), skipLinks && (jsxRuntime.jsx("ul", { className: "bcds-header--skiplinks", children: skipLinks.map((link, index) => {
                        return jsxRuntime.jsx("li", { children: link }, `skiplink-${index}`);
                    }) })), title && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { className: "bcds-header--line" }), getTitle()] })), children] }) }));
}
...
function Heading({ color = "primary", isUnstyled = false, ...props }) {
    return (jsxRuntime.jsx($5cb03073d3f54797$export$a8a3e93435678ff9, { className: isUnstyled ? undefined : `bcds-react-aria-Heading ${color}`, ...props }));
}
...
function InlineAlert({ variant = "info", title, description, isIconHidden = false, isCloseable = false, role = "note", buttons, children, onClose, ...props }) {
    return (jsxRuntime.jsxs("div", { className: `bcds-Inline-Alert ${variant} ${isCloseable ? "closeable" : null}`, ...props, children: [!isIconHidden && (jsxRuntime.jsx("span", { className: "bcds-Inline-Alert--icon", children: getIcon(variant) })), jsxRuntime.jsx("div", { className: "bcds-Inline-Alert--container", role: role, "aria-labelledby": "alert-title", children: children ? (children) : (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [title && (jsxRuntime.jsx("span", { className: "title", id: "alert-title", children: title })), description && jsxRuntime.jsx("span", { className: "description", children: description }), buttons && (jsxRuntime.jsx(ButtonGroup, { alignment: "end", orientation: "horizontal", children: buttons }))] })) }), isCloseable && (jsxRuntime.jsx("span", { className: "bcds-Inline-Alert--closeIcon", children: jsxRuntime.jsx(Button, { variant: "tertiary", isIconButton: true, size: "small", "aria-label": "Close this alert", type: "button", onPress: onClose, children: jsxRuntime.jsx(SvgCloseIcon, {}) }) }))] }));
}
...
function Link({ children, size = "medium", danger = false, isButton = false, buttonVariant = "primary", isUnstyled = false, iconLeft, iconRight, ariaLabel, ...props }) {
    return (jsxRuntime.jsxs($4f118338184dc1d9$export$a6c7ac8248d6e38a, { className: !isUnstyled
            ? isButton
                ? `bcds-react-aria-Button ${size} ${buttonVariant} ${danger && "danger"}`
                : `bcds-react-aria-Link ${size} ${danger && "danger"}`
            : undefined, "aria-label": ariaLabel, ...props, children: [iconLeft && (jsxRuntime.jsx("span", { className: "bcds-react-aria-Link--Icon", children: iconLeft })), children, iconRight && (jsxRuntime.jsx("span", { className: "bcds-react-aria-Link--Icon", children: iconRight }))] }));
}
...
function Modal({ children, ...props }) {
    return (jsxRuntime.jsx($f3f84453ead64de5$export$2b77a92f1a5ad772, { className: "bcds-react-aria-Modal", ...props, children: children }));
}
...
function Radio({ value, children, ...props }) {
    return (jsxRuntime.jsx($b6c3ddc6086f204d$export$d7b12c4107be0d61, { className: "bcds-react-aria-Radio", value: value, ...props, children: children }));
}
...
function RadioGroup({ orientation = "vertical", label, description, children, errorMessage, flexWrap = "nowrap", ...props }) {
    return (jsxRuntime.jsx($b6c3ddc6086f204d$export$a98f0dcb43a68a25, { className: "bcds-react-aria-RadioGroup", ...props, children: ({ isRequired, isInvalid }) => (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [label && (jsxRuntime.jsxs($01b77f81d0f07f68$export$b04be29aa201d4f5, { className: "bcds-react-aria-RadioGroup--label", children: [label, " ", isRequired && "(required)"] })), jsxRuntime.jsx("div", { className: `bcds-react-aria-RadioGroup--options ${orientation} flex-wrap-${flexWrap}`, children: children }), description && (jsxRuntime.jsx($514c0188e459b4c0$export$5f1af8db9871e1d6, { slot: "description", className: "bcds-react-aria-RadioGroup--description", children: description })), isInvalid && (jsxRuntime.jsxs("div", { className: "bcds-react-aria-RadioGroup--error", children: [jsxRuntime.jsx(SvgExclamationIcon, {}), jsxRuntime.jsx($ee014567cb39d3f0$export$f551688fc98f2e09, { children: errorMessage })] }))] })) }));
}
...
function Select({ items, sections, label, description, placeholder, size = "medium", errorMessage, ...props }) {
    return (jsxRuntime.jsx($82d7e5349645de74$export$ef9b1a59e592288f, { ...props, className: "bcds-react-aria-Select", children: ({ isOpen, isRequired, isInvalid }) => (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [label && (jsxRuntime.jsx($01b77f81d0f07f68$export$b04be29aa201d4f5, { className: "bcds-react-aria-Select--Label", children: isRequired ? `${label} (required)` : label })), jsxRuntime.jsxs($d2b4bc8c273e7be6$export$353f5b6fc5456de1, { className: `bcds-react-aria-Select--Button ${size === "medium" ? "medium" : "small"} ${isInvalid && "invalid"}`, children: [jsxRuntime.jsx($82d7e5349645de74$export$e288731fd71264f0, { className: "bcds-react-aria-SelectValue", children: (value) => {
                                if (value.selectedText)
                                    return value.selectedText;
                                if (placeholder)
                                    return placeholder;
                                return "Select an item";
                            } }), isInvalid && jsxRuntime.jsx(SvgExclamationIcon, {}), isOpen ? jsxRuntime.jsx(SvgChevronUpIcon, {}) : jsxRuntime.jsx(SvgChevronDownIcon, {})] }), description && (jsxRuntime.jsx($514c0188e459b4c0$export$5f1af8db9871e1d6, { slot: "description", className: `bcds-react-aria-Select--Description`, children: description })), jsxRuntime.jsx($ee014567cb39d3f0$export$f551688fc98f2e09, { className: "bcds-react-aria-Select--Error", children: errorMessage }), jsxRuntime.jsx($07b14b47974efb58$export$5b6b19405a83ff9d, { className: "bcds-react-aria-Select--Popover", offset: 4, children: jsxRuntime.jsx($eed445e0843c11d0$export$41f133550aa26f48, { className: "bcds-react-aria-Select--ListBox", 
...
function SvgBetaIcon({ id = "beta-icon" }) {
    return (jsxRuntime.jsx("svg", { id: id, width: "20", height: "20", viewBox: "0 0 448 512", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("g", { children: jsxRuntime.jsx("path", { d: "M288 0L160 0 128 0C110.3 0 96 14.3 96 32s14.3 32 32 32l0 132.8c0 11.8-3.3 23.5-9.5 33.5L10.3 406.2C3.6 417.2 0 429.7 0 442.6C0 480.9 31.1 512 69.4 512l309.2 0c38.3 0 69.4-31.1 69.4-69.4c0-12.8-3.6-25.4-10.3-36.4L329.5 230.4c-6.2-10.1-9.5-21.7-9.5-33.5L320 64c17.7 0 32-14.3 32-32s-14.3-32-32-32L288 0zM192 196.8L192 64l64 0 0 132.8c0 23.7 6.6 46.9 19 67.1L309.5 320l-171 0L173 263.9c12.4-20.2 19-43.4 19-67.1z", fill: "currentColor" }) }) }));
}

function SvgTooltipArrowUp({ id = "tooltip-arrow" }) {
    return (jsxRuntime.jsx("svg", { id: id, width: "19", height: "9", viewBox: "0 0 19 9", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("g", { children: jsxRuntime.jsx("path", { d: "M8.4188 1.41421C9.19985 0.633163 10.4662 0.633165 11.2472 1.41421L18.833 9L0.833008 9L8.4188 1.41421Z", fill: "currentColor" }) }) }));
}
...
function Tag({ color = "blue", tagStyle = "rectangular", size = "small", icon, id, textValue, }) {
    return (jsxRuntime.jsx($eaf9e70818b436db$export$3288d34c523a1192, { className: `bcds-react-aria-Tag ${color} ${tagStyle} ${size}`, id: id, textValue: textValue, children: ({ allowsRemoving, isDisabled }) => (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [icon, textValue, !isDisabled && allowsRemoving && (jsxRuntime.jsx($d2b4bc8c273e7be6$export$353f5b6fc5456de1, { "aria-label": `Remove ${textValue}`, slot: "remove", children: jsxRuntime.jsx("svg", { width: "14", height: "15", viewBox: "0 0 14 15", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("g", { id: "Icons / Close", children: jsxRuntime.jsx("path", { id: "Vector", d: "M12.6004 3.03239L11.4684 1.90039L7.00039 6.36839L2.53239 1.90039L1.40039 3.03239L5.86839 7.50039L1.40039 11.9684L2.53239 13.1004L7.00039 8.63239L11.4684 13.1004L12.6004 11.9684L8.13239 7.50039L12.6004 3.03239Z", fill: "currentColor" }) }) }) }))] })) }));
}
...
function TagGroup({ children, label, description, errorMessage, ...props }) {
    return (jsxRuntime.jsxs($eaf9e70818b436db$export$67ea30858aaf75e3, { className: "bcds-react-aria-TagGroup", ...props, children: [label && (jsxRuntime.jsx($01b77f81d0f07f68$export$b04be29aa201d4f5, { className: "bcds-react-aria-TagGroup--Label", children: label })), children, description && (jsxRuntime.jsx($514c0188e459b4c0$export$5f1af8db9871e1d6, { slot: "description", className: "bcds-react-aria-TagGroup--Text-description", children: description })), errorMessage && (jsxRuntime.jsxs($514c0188e459b4c0$export$5f1af8db9871e1d6, { slot: "errorMessage", className: "bcds-react-aria-TagGroup--Text-error", children: [jsxRuntime.jsx(SvgExclamationIcon, {}), errorMessage] }))] }));
}
...
function TagList({ items, orientation = "horizontal", renderEmptyState, ...props }) {
    return (jsxRuntime.jsx($eaf9e70818b436db$export$f9fef0f55402315b, { className: `bcds-react-aria-TagList ${orientation}`, ...props, renderEmptyState: renderEmptyState, items: items, children: (item) => $dbSRa$react.createElement(Tag, { ...item, key: item.id }) }));
}
...
function Text({ elementType = "span", size = "medium", color = "primary", isUnstyled = false, ...props }) {
    return (jsxRuntime.jsx($514c0188e459b4c0$export$5f1af8db9871e1d6, { elementType: elementType, className: isUnstyled ? undefined : `bcds-react-aria-Text ${size} ${color}`, ...props, children: props.children }));
}
...
function TextArea({ label, description, errorMessage, maxLength, onChange, value, ...props }) {
    ...
    const [charCount, setCharCount] = $dbSRa$react.useState(value ? value.length : 0);
    function handleChange(text) {
        if (onChange)
            onChange(text);
        setCharCount(text.length);
    }
    return (jsxRuntime.jsx($bcdf0525bf22703d$export$2c73285ae9390cec, { className: `bcds-react-aria-TextArea`, ...props, children: ({ isRequired, isInvalid }) => (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [label && (jsxRuntime.jsx($01b77f81d0f07f68$export$b04be29aa201d4f5, { className: "bcds-react-aria-TextArea--Label", children: isRequired ? `${label} (required)` : label })), jsxRuntime.jsx("div", { className: "bcds-react-aria-TextArea--Container", children: jsxRuntime.jsx($216918bed6669f72$export$f5c9f3c2c4054eec, { className: "bcds-react-aria-TextArea--Input", value: value, onChange: (e) => handleChange(e.target.value) }) }), description || maxLength ? (jsxRuntime.jsxs("div", { className: "bcds-react-aria-TextArea--Description", children: [description && (jsxRuntime.jsx($514c0188e459b4c0$export$5f1af8db9871e1d6, { slot: "description", className: "text", children: description })), maxLength && (jsxRuntime.jsxs("div", { className: "counter", children: [charCount, "/", maxLength] }))] })) : null, isInvalid && (jsxRuntime.jsxs("div", { className: "bcds-react-aria-TextArea--Error", children: [jsxRuntime.jsx(SvgExclamationIcon, {}), jsxRuntime.jsx($ee014567cb39d3f0$export$f551688fc98f2e09, { children: errorMessage })] }))] })) }));
}
...
function TextField({ size, label, description, errorMessage, iconLeft, iconRight, ...props }) {
    return (jsxRuntime.jsx($bcdf0525bf22703d$export$2c73285ae9390cec, { className: "bcds-react-aria-TextField", ...props, children: ({ isRequired, isInvalid }) => (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [label && (jsxRuntime.jsxs($01b77f81d0f07f68$export$b04be29aa201d4f5, { className: "bcds-react-aria-TextField--Label", children: [label, isRequired && (jsxRuntime.jsx("span", { className: "bcds-react-aria-TextField--Label required", children: "(required)" }))] })), jsxRuntime.jsxs("div", { className: `bcds-react-aria-TextField--container ${size === "small" ? "small" : "medium"}`, children: [iconLeft, jsxRuntime.jsx($3985021b0ad6602f$export$f5b8910cec6cf069, { className: "bcds-react-aria-TextField--Input" }), isInvalid && jsxRuntime.jsx(SvgExclamationIcon, {}), iconRight] }), description && (jsxRuntime.jsx($514c0188e459b4c0$export$5f1af8db9871e1d6, { slot: "description", className: `bcds-react-aria-TextField--Description`, children: description })), jsxRuntime.jsx($ee014567cb39d3f0$export$f551688fc98f2e09, { className: "bcds-react-aria-TextField--Error", children: errorMessage })] })) }));
}
...
function Switch({ labelPosition = "right", children, ...props }) {
    return (jsxRuntime.jsxs($8e59e948500a8fe1$export$b5d5cf8927ab7262, { className: `bcds-react-aria-Switch`, ...props, children: [labelPosition === "left" && jsxRuntime.jsx(jsxRuntime.Fragment, { children: children }), jsxRuntime.jsx("div", { className: "indicator" }), labelPosition === "right" && jsxRuntime.jsx(jsxRuntime.Fragment, { children: children })] }));
}
...
function Tooltip(props) {
    return (jsxRuntime.jsxs($4e3b923658d69c60$export$28c660c63b792dea, { className: "bcds-react-aria-Tooltip", ...props, children: [jsxRuntime.jsx($44f671af83e7d9e0$export$746d02f47f4d381, { className: "bcds-react-aria-OverlayArrow", children: jsxRuntime.jsx(SvgTooltipArrowUp, {}) }), jsxRuntime.jsx(jsxRuntime.Fragment, { children: props.children })] }));
}
...
exports.SvgBcLogo = SvgBcLogo;
exports.SvgBcOutlineIcon = SvgBcOutlineIcon;
exports.SvgBetaIcon = SvgBetaIcon;
...
exports.SvgCloseIcon = SvgCloseIcon;
exports.SvgDashIcon = SvgDashIcon;
exports.SvgExclamationCircleIcon = SvgExclamationCircleIcon;
exports.SvgExclamationIcon = SvgExclamationIcon;
exports.SvgInfoIcon = SvgInfoIcon;
exports.SvgTooltipArrowUp = SvgTooltipArrowUp;
